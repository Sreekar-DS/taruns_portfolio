  ...
  function createImage(item) {
    ...
    return `
      <div class="portfolio-card-image-wrap">
        <img class="portfolio-card-image" src="${escapeHtml(imageUrl)}" alt="${escapeHtml(item.title)} course image" loading="lazy" onerror="this.closest('.portfolio-card-image-wrap').style.display='none';">
      </div>
    `;
  }
